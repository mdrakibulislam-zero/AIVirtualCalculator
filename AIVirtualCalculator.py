...
while True:
    ...
    # Draw All
    cv2.rectangle(img, (800, 70), (800 + 400, 70 + 100), (162, 155, 254), cv2.FILLED)
    ...
    if hands:
        ...
        # If Clicked Check Which Button & Perform Action
